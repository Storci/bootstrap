...
common.cardLineTrend('IDDivChart1', entityName, 'Pressa_Motori_Estrusore_PV_Pressione', '', 'bar')
// Grafico card Temperatura Cilindro
common.cardLineTrend('IDDivChart2', entityName, 'Pressa_Termostatazione_Cilindro_PV_Temperatura', 'Pressa_Termostatazione_Cilindro_SP_Temperatura', '°C')
// Grafico card Temperatura Testata
common.cardLineTrend('IDDivChart3', entityName, 'Pressa_Termostatazione_Testata_PV_Temperatura', 'Pressa_Termostatazione_Testata_SP_Temperatura', '°C')
...
// ******************** FUNCTION ********************
// Funzione che imposta i dati della pressa nei rispettivi campi
async function setLineinfo(entityName){
  ...
  let line_info = await tw.getLinePressInfo(entityName)
  ...
  $("#recipe_number").text(line_info.Impasto_Ricetta_Numero_Ricetta);
	...
	$("#head_temp_sp").text(line_info.Pressa_Termostatazione_Cilindro_SP_Temperatura.toFixed(2)+ " °C");
